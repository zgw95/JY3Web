//中间分为四个部分
$("#middle").append("<div id='second'></div>"+	  	
				"<div id='third'></div>"+
				"<div id='forth'></div>")
//第一部分
...
$("#second div:first").append("<div><img src='img/logo/外星人.svg'></div>"+
						"<div><img id='hwlg' src='img/logo/华为.svg'></div>"+ 
...
$("#second img:eq(0)").addClass("zhuan")
$("#second img:eq(1)").addClass("zhuan2")
$("#second img:eq(2)").addClass("zhuan")
$("#second img:eq(3)").addClass("zhuan2")
$("#second img:eq(4)").addClass("zhuan")
$("#second img:eq(5)").addClass("zhuan2")


//第三部分 热卖单品
$("#third").append("<div id='third-top'></div> <div id='third-bottom'></div>")
$("#third-top").append("热卖单品")
$("#third-bottom").append("<a href='测试用mate20.html'><div></div></a> <div></div> <div></div> <div></div>")
